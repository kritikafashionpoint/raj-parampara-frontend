...
export default function WhyChooseUs() {
    const features = [
        {
            icon: <FiAward />,
            title: "100% हस्तनिर्मित उत्पाद",
            desc: "राजस्थान के कुशल कारीगरों द्वारा प्रेम और परंपरा के साथ तैयार किए गए असली हस्तनिर्मित उत्पाद।",
        },
        {
            icon: <FiUsers />,
        ...
        },
        {
            ...
            desc: "हर उत्पाद्सगुणवत्ता जांच के बाद ही आपके घर तक पहुँचाया जाता है।",
        },
    ];
            ...
            <div className="max-w-[1420px] mx-auto lg:px-6 px-4">
                ...
                <div className="text-center max-w-3xl mx-auto">
                    ...
                    <p className="text-gray-600 mt-5 leading-8">
                        हम केवल उत्पाद्सनहीं बेचते, बल्कि राजस्थान की समृद्ध
